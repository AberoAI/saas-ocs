    ...
    <main className="min-h-screen flex items-center justify-center bg-white">
      <div className="max-w-3xl px-6 py-10">
        ...
        <section className="mt-6 space-y-2 text-gray-800">
          <p><strong>About:</strong> We provide AI-powered WhatsApp Cloud API automation for customer service (OCS + AI), including real-time inbox, auto-replies, and dashboards.</p>
          <p><strong>Website:</strong> <a className="underline" href={domain} target="_blank" rel="noreferrer">{domain}</a></p>
          <p><strong>Contact:</strong> {email} · {phone}</p>
          <p><strong>Legal:</strong> Business operates under applicable terms & privacy policies. Request available upon review.</p>
        </section>
