// apps/frontend/components/solutionspage/Page3.tsx
"use client";
...
export default function Page3() {
  ...
  const headlineLines = t("solutions.page3.headline").split("\n");
  const bodyLines = t("solutions.page3.body").split("\n");
  const microlineLines = t("solutions.page3.microline").split("\n");

  return (
    <section id="solutions-page-3" className="relative z-10 bg-white py-24">
