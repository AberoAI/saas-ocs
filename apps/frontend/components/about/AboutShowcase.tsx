  ...
  return (
    <section id="about" className="bg-white">
      <div className="mx-auto max-w-7xl px-6 py-12 md:py-16">
        {/* Kurangi tinggi bagian atas sebesar ~20% dengan translateY */}
        <div className="relative w-full h-[575px] md:h-[655px] lg:h-[695px] overflow-hidden">
          <svg
            viewBox="0 0 1882 1032"
            preserveAspectRatio="xMidYMid meet"
            className="absolute inset-0 h-full w-full -translate-y-[20%]"
            aria-hidden="true"
          >
            <defs>
