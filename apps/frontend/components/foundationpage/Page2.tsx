// apps/frontend/components/foundationpage/Page2.tsx
"use client";
...
export default function Page2() {
  ...
  const headlineLines = t("foundation.page2.headline").split("\n");
  const bodyLines = t("foundation.page2.body").split("\n");

  return (
    <section id="foundation-page-2" className="relative z-10 bg-white py-24">
