...
export default function AboutShowcase({ className = "", children }: Props) {
  ...
  return (
    <section className={["relative", className].join(" ")}>
      {/* WRAPPER FULL-BLEED yang tak terpengaruh max-w parent */}
      <div className="relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] w-screen px-[8px]">
        {/* Kartu showcase */}
        <div className="relative h-[85vh] w-full overflow-hidden rounded-[45px]">
          <svg
