    ...
    <>
      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        ...
        <ul className="list-disc list-inside mb-6 text-black/70">
          <li><strong>AI Autoreply</strong> – instant and consistent responses to customer inquiries.</li>
          <li><strong>Multi-tenant Dashboard</strong> – manage multiple business units or branches in one place.</li>
          <li><strong>Realtime Analytics</strong> – track SLA, response time, and customer satisfaction.</li>
        </ul>
