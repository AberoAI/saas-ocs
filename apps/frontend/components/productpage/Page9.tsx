// apps/frontend/components/productpage/Page9.tsx
"use client";
...
export default function Page9() {
  ...
  const headlineLines = t("product.page9.headline").split("\n");
  const subheadlineLines = t("product.page9.subheadline").split("\n");
  const bodyLines = t("product.page9.body").split("\n");
  const microlineLines = t("product.page9.microline").split("\n");

  return (
    <section id="product-page-9" className="relative z-10 bg-white py-24">
