// apps/frontend/components/productpage/Page4.tsx
"use client";
...
export default function Page4() {
  ...
  const headlineLines = t("product.page4.headline").split("\n");
  const subheadlineLines = t("product.page4.subheadline").split("\n");
  const microlineLines = t("product.page4.microline").split("\n");

  return (
    <section id="product-page-4" className="relative z-10 bg-white py-24">
