// apps/frontend/components/productpage/Page1.tsx
"use client";
...
export default function Page1() {
  ...
  const headlineLines = t("product.page1.headline").split("\n");
  const subheadlineLines = t("product.page1.subheadline").split("\n");
  const bodyLines = t("product.page1.body").split("\n");

  return (
    <section id="product-page-1" className="relative z-10 bg-white py-24">
