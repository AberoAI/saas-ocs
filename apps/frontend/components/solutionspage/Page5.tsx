// apps/frontend/components/solutionspage/Page5.tsx
"use client";
...
export default function Page5() {
  ...
  const headlineLines = t("solutions.page5.headline").split("\n");
  const bodyLines = t("solutions.page5.body").split("\n");
  const microlineLines = t("solutions.page5.microline").split("\n");

  return (
    <section id="solutions-page-5" className="relative z-10 bg-white py-24">
