    ...
    <main className="min-h-screen flex items-center justify-center bg-white">
      <div className="max-w-3xl px-6 py-10">
        ...
        <section className="mt-6 space-y-2 text-gray-800 leading-relaxed">
          <p><strong>About:</strong> We provide AI-powered WhatsApp Cloud API automation for customer service (OCS + AI), including real-time inbox, auto-replies, dashboards, and analytics.</p>
          ...
          <p><strong>Legal:</strong> Our Privacy Policy and Terms are available below.</p>
        </section>
