// apps/frontend/components/solutionspage/Page2.tsx
"use client";
...
export default function Page2() {
  ...
  const headlineLines = t("solutions.page2.headline").split("\n");
  const bodyLines = t("solutions.page2.body").split("\n");
  const microlineLines = t("solutions.page2.microline").split("\n");

  return (
    <section id="solutions-page-2" className="relative z-10 bg-white py-24">
