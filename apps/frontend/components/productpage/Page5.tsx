// apps/frontend/components/productpage/Page5.tsx
"use client";
...
export default function Page5() {
  ...
  const headlineLines = t("product.page5.headline").split("\n");
  const subheadlineLines = t("product.page5.subheadline").split("\n");
  const bodyLines = t("product.page5.body").split("\n");
  const microlineLines = t("product.page5.microline").split("\n");

  return (
    <section id="product-page-5" className="relative z-10 bg-white py-24">
