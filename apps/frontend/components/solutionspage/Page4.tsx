// apps/frontend/components/solutionspage/Page4.tsx
"use client";
...
export default function Page4() {
  ...
  const headlineLines = t("solutions.page4.headline").split("\n");
  const bodyLines = t("solutions.page4.body").split("\n");
  const microlineLines = t("solutions.page4.microline").split("\n");

  return (
    <section id="solutions-page-4" className="relative z-10 bg-white py-24">
