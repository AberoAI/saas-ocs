// apps/frontend/components/foundationpage/Page4.tsx
"use client";
...
export default function Page4() {
  ...
  const headlineLines = t("foundation.page4.headline").split("\n");
  const bodyLines = t("foundation.page4.body").split("\n");

  return (
    <section id="foundation-page-4" className="relative z-10 bg-white py-24">
