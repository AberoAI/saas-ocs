// apps/frontend/components/solutionspage/Page1.tsx
"use client";
...
export default function Page1() {
  ...
  const headlineLines = t("solutions.page1.headline").split("\n");
  const bodyLines = t("solutions.page1.body").split("\n");
  const microlineLines = t("solutions.page1.microline").split("\n");

  return (
    <section id="solutions-page-1" className="relative z-10 bg-white py-24">
