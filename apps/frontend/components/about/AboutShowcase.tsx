  ...
  return (
    <section id="about" className="bg-white">
      <div className="mx-auto max-w-7xl px-6 py-12 md:py-16">
        {/* Kontainer tinggi bisa diatur bebas tanpa memotong */}
        <div className="relative w-full h-[575px] md:h-[655px] lg:h-[695px]">
          <svg
          ...
          >
            <defs>
              {/* ClipPath pakai path SVG asli → bentuk identik, tidak terpotong */}
            ...
            {/* Rect di-clip oleh path → tidak ada cropping, rasio path terjaga */}
