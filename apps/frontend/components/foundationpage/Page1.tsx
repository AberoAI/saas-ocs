// apps/frontend/components/foundationpage/Page1.tsx
"use client";
...
export default function Page1() {
  ...
  const headlineLines = t("foundation.page1.headline").split("\n");
  const bodyLines = t("foundation.page1.body").split("\n");

  return (
    <section id="foundation-page-1" className="relative z-10 bg-white py-24">
