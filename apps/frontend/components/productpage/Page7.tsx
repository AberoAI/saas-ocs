// apps/frontend/components/productpage/Page7.tsx
"use client";
...
export default function Page7() {
  ...
  const headlineLines = t("product.page7.headline").split("\n");
  const subheadlineLines = t("product.page7.subheadline").split("\n");
  const bodyLines = t("product.page7.body").split("\n");
  const microlineLines = t("product.page7.microline").split("\n");

  return (
    <section id="product-page-7" className="relative z-10 bg-white py-24">
