// apps/frontend/components/productpage/Page6.tsx
"use client";
...
export default function Page6() {
  ...
  const headlineLines = t("product.page6.headline").split("\n");
  const subheadlineLines = t("product.page6.subheadline").split("\n");
  const bodyLines = t("product.page6.body").split("\n");
  const microlineLines = t("product.page6.microline").split("\n");

  return (
    <section id="product-page-6" className="relative z-10 bg-white py-24">
