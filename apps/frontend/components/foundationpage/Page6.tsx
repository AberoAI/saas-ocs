// apps/frontend/components/foundationpage/Page6.tsx
"use client";
...
export default function Page6() {
  ...
  const headlineLines = t("foundation.page6.headline").split("\n");
  const bodyLines = t("foundation.page6.body").split("\n");

  return (
    <section id="foundation-page-6" className="relative z-10 bg-white py-24">
