// apps/frontend/components/foundationpage/Page5.tsx
"use client";
...
export default function Page5() {
  ...
  const headlineLines = t("foundation.page5.headline").split("\n");
  const bodyLines = t("foundation.page5.body").split("\n");

  return (
    <section id="foundation-page-5" className="relative z-10 bg-white py-24">
